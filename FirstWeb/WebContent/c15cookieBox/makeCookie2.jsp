...
<%
	...
	Cookie ck = CookieBox.createCookie("bakery", "bread");
	...
	Cookie ck2 = CookieBox.createCookie("snack", "burger", 60 * 30);
	//Cookie ck2 = new Cookie("title", "주토피아"); //한글 값은 인코딩 필요..?
	response.addCookie(ck2);

	Cookie ck3 = CookieBox.createCookie("place", "concert", 60 * 60 * 2);
...
<body>
	...
	<a href="../cookieJS/cookieJS.jsp">쿠키 javascript 결과 바로가기</a>
