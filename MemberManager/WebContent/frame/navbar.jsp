...
<div id="navbar" class="nav nav-masthead justify-content-center">
	...
	<a class="dropdown-toggle nav-link" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
	    ...
	    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
	      <a class="dropdown-item" href="<c:url value='/member/login.jsp'/>">로그인</a>
	      <a class="dropdown-item" href="<c:url value='/member/myPage2.jsp'/>">내정보보기</a>      
	      <div class="dropdown-divider"></div>
	      <a class="dropdown-item" href="<c:url value='/member/logout.jsp'/>">로그아웃</a>  
	    </div>		  
</div>
